package net.deepacat.ccamorewires.compat.forge;
/*
...
public class ForgeEnergyDisplaySource extends PercentOrProgressBarDisplaySource {
	...
	//private final static DisplayBehaviour BEHAVIOUR = AllDisplayBehaviours.register(ccawires.asResource(INSTANCE.getTranslationKey()), INSTANCE);
	...
	public void initConfigurationWidgets(DisplayLinkContext context, ModularGuiLineBuilder builder,
		...
		builder.addSelectionScrollInput(0, 120,
			(si, l) -> si
				.forOptions(List.of(
							Component.translatable("ccawires.display_source.accumulator.progress_bar"),
							Component.translatable("ccawires.display_source.accumulator.percent"),
							Component.translatable("ccawires.display_source.accumulator.current"),
							Component.translatable("ccawires.display_source.accumulator.max"),
							Component.translatable("ccawires.display_source.accumulator.remaining")
						)) // Lang.translatedOptions("display_source.kinetic_stress", "progress_bar", "percent", "current", "max", "remaining")
				.titled(Component.translatable("ccawires.display_source.accumulator.display")), "Mode");
	}
